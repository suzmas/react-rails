...
class TestSpider(scrapy.Spider):
    ...
    def start_requests(self):
        url = 'https://kingofhappyhour.com/sandiego/bars/offshore_tavern_grill'
        yield scrapy.Request(url=url, callback=self.parse_bar, meta={'dont_redirect': True, 'handle_httpstatus_list': [302, 301]})
